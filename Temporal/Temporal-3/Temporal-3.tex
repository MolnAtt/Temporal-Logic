...
\felirat{1.5}{1}{1}{4}{2.5}{
\only<1>{\begin{tikzpicture}[world/.style={inner sep=.4mm, fill=black, circle},>=stealth, scale=.7]
\node[world] (v1) at (0,-2) {};
\node[world] (v2) at (-1,0) {};
\node[world] (v3) at (1,0) {};
\node[anchor=south] at (v2) {$w_1\Vdash p$};
...
\draw[->]  (v1) edge (v3);
\end{tikzpicture}}
\only<2->{\begin{tikzpicture}[world/.style={inner sep=.4mm, fill=black, circle},>=stealth, scale=.7]
\node[world] (v1) at (-1,-2) {};
\node[world] (v2) at (-1,0) {};
\node[world] (v3) at (1,0) {};
\node(v1') [world] at (1,-2) {};
...
But the bundled treehugger won't.}
\end{minipage}};
\end{tikzpicture}
